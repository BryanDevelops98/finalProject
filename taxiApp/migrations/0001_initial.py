# Generated by Django 3.2.9 on 2021-11-17 23:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxiApp.car')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'created'), ('cancelled', 'cancelled')], max_length=85)),
